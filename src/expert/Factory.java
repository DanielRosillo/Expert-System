 ...
 * Esta clase es la fábrica de eventos y hechos del sistema, se encarga de generarlos mediante la información suministrada por el motor de inferencia.
 */
public class Factory
{
	...
	if (eventStr.contains("="))//Verificamos si la sentencia es de tipo entero.
	{
		...
		return new IntEvent(aux[0].trim(), Integer.parseInt(aux[1].trim()), pregunta, 0);
	    }
	}
